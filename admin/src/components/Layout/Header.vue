    ...
    <div class="flex items-center space-x-4">
      ...
      <el-dropdown @command="handleCommand" trigger="click">
        <div class="flex items-center cursor-pointer hover:bg-slate-50 p-1.5 rounded-xl transition-colors">
          <div class="w-8 h-8 rounded-full bg-gradient-to-tr from-primary-500 to-indigo-400 flex items-center justify-center text-white text-xs font-bold mr-2 shadow-sm">
