...
<template>
  <div class="docs-root animate-in fade-in slide-in-from-bottom-4 duration-500">
    ...
    <section class="page-head">
      <div>
        ...
        <h1>接入文档</h1>
        <p class="subtitle">API 接入地址、认证方式与全部接口参考 — 与任何 OpenAI / Anthropic 兼容客户端配合使用。</p>
      </div>
    </section>
    ...
    <div class="docs-layout">
      ...
      <main class="docs-content">
        ...
        <section id="base-url" class="doc-section">
          ...
          <p class="section-desc">所有 API 请求均以此地址为前缀，兼容 OpenAI SDK 的 <code>baseURL</code> 参数和 Anthropic SDK 的 <code>base_url</code> 参数。</p>
          <div class="url-bar">
        ...
        <section id="auth" class="doc-section">
          ...
          <p class="section-desc">每个请求须在 HTTP 请求头中携带 API Key，格式为标准的 Bearer Token。</p>
        ...
        <section id="openai" class="doc-section">
          ...
          <p class="section-desc">以下接口完全兼容 OpenAI 协议，可直接替换 <code>https://api.openai.com</code> 地址使用，无需修改客户端代码。</p>
        ...
        <section id="anthropic" class="doc-section">
          ...
          <p class="section-desc">以下接口兼容 Anthropic 官方协议，可直接替换 <code>https://api.anthropic.com</code>，配合 <code>anthropic</code> SDK 使用。</p>
        ...
        <section id="code" class="doc-section">
          ...
          <p class="section-desc">以下示例演示如何调用 <code>POST /v1/chat/completions</code>，将 <code>YOUR_API_KEY</code> 替换为实际 Key 即可运行。</p>
...
.code-body {
  /* same as pre above, no extra styles needed */
}
</style>
