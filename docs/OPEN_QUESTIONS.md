...
7. MVP implements custom OpenAI-compatible providers first and reserves Anthropic protocol support through the adapter interface.
...
2. First provider list.
   - Recommended MVP providers: DeepSeek, SiliconFlow, OpenRouter, Azure OpenAI, DashScope OpenAI-compatible mode.
