...
> 本文只保留 0.2.0 的历史账务迁移记录，不是当前发布待办。当前 schema v24、迁移链、备份/恢复和上线检查统一以 [`SCHEMA_RELEASE_RUNBOOK.md`](SCHEMA_RELEASE_RUNBOOK.md)、[`DATABASE.md`](DATABASE.md) 和 [`RUNTIME_ROLES.md`](RUNTIME_ROLES.md) 为准；本文中的未勾选项不代表当前版本尚未完成。
