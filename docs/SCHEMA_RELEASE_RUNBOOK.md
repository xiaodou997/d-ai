...
当前仓库基线为 schema v27。发布制品应先运行 `scripts/generate_release_metadata.sh release` 生成
...
SCHEMA_REPLAY_DATABASE_URL='postgres://postgres:postgres@127.0.0.1:15432/dai_v27_test?sslmode=disable' \
