...
- `local-chat-test` and `local-responses-test`: `billable_unit_type = token`
- `local-embedding-test`: `billable_unit_type = input_token`
- `local-image-test`: `billable_unit_type = image`
