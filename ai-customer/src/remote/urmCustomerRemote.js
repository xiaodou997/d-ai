...
import { loadUrmCustomerManifest, resolveManifestUrl } from './urmCustomerManifest'
...
export async function loadUrmCustomerRemoteComponent() {
...
export function getRegisteredUrmCustomerRemoteName() {
