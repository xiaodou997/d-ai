...
export interface UseListPageOptions<TQuery extends Record<string, unknown>, TRow> {
...
export interface UseListPageReturn<TQuery extends Record<string, unknown>, TRow> {
  rows: Ref<TRow[]>;
  total: Ref<number>;
  loading: Ref<boolean>;
 ...
 */
export function useListPage<TQuery extends Record<string, unknown>, TRow>(
