...
const data = useAdminOverviewData(["summary", "trend", "system", "errors", "proxy"], "24h");
const { selectedRangeId, loading, lastUpdatedAt, selectedRange, summary, trend, system, errors, proxyNodes, refresh, changeRange } = data;
...
<template>
  <div class="overview-page">
    <PortalPagePanel :icon="Gauge" :breadcrumbs="[{ label: '概览' }, { label: '运维总览' }]" description="聚合请求吞吐、延迟、错误和运行时资源，帮助快速定位需要处理的波动。">
      ...
      <div class="overview-body">
        ...
        <PortalContentCard title="代理出口节点" description="运维总览只展示节点可用性，节点配置与探测详情进入系统模块。">
