...
async function fetchWechatConfig() {
  ...
  try {
    const cfg = await urmAdminApi.getWechatConfig();
...
async function submitWechatConfig() {
  ...
  try {
    await urmAdminApi.updateWechatConfig({
...
async function fetchPaymentSettings() {
  ...
  try {
    const settings = await urmAdminApi.getPaymentSettings();
...
async function submitPaymentSettings() {
  ...
  try {
    ...
    await urmAdminApi.updatePaymentSettings(body);
          ...
          <section class="settings-section">
            ...
            <div class="form-grid">
              ...
              <el-form-item label="回调地址根路径">
                <el-input v-model="wechatForm.notifyBaseUrl" placeholder="https://your-domain/urm" />
              </el-form-item>
            </div>
          </section>
