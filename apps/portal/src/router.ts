...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      // ── 共享页面 ──
      { path: "overview", component: RoleBasedView, props: { view: "overview" }, meta: { title: "概览" } },
      { path: "profile", component: RoleBasedView, props: { view: "profile" }, meta: { title: "个人资料" } },
      ...
      { path: "platform/users", component: RoleBasedView, props: { view: "user-management" }, meta: { title: "终端用户", allowedUserTypes: [1, 2, 3] } },
      ...
      // ── 财务管理（userType 1/2/3）──
      { path: "billing/tenant-credit", component: () => import("./views/admin/platform/AccountOverviewView.vue"), meta: { title: "租户积分", allowedUserTypes: [1, 2] } },
      { path: "billing/recharge", component: RoleBasedView, props: { view: "recharge-records" }, meta: { title: "充值记录", allowedUserTypes: [1, 2, 3, 4] } },
      { path: "billing/transactions", component: RoleBasedView, props: { view: "transactions" }, meta: { title: "积分明细", allowedUserTypes: [1, 2, 3, 4] } },
      ...
      { path: "billing/cash-accounts", component: () => import("./views/admin/platform/CashAccountsView.vue"), meta: { title: "现金账户", allowedUserTypes: [1, 2] } },
      ...
      { path: "ai-gateway/usage", component: () => import("./views/admin/ai/gateway/UsageView.vue"), meta: { title: "使用记录", allowedUserTypes: [1, 2] } },
      ...
      { path: "ai-gateway/subscriptions", component: () => import("./views/tenant/ai/SubscriptionManagementView.vue"), meta: { title: "订阅套餐", allowedUserTypes: [3] } },

      // ── 租户 AI 运营（userType 3）──
      { path: "workspace/groups", component: RoleBasedView, props: { view: "groups" }, meta: { title: "模型分组", allowedUserTypes: [3, 4] } },
      { path: "workspace/groups/:id", component: () => import("./views/tenant/ai/GroupDetailView.vue"), meta: { title: "分组详情", allowedUserTypes: [3] } },
      { path: "workspace/keys", component: RoleBasedView, props: { view: "keys" }, meta: { title: "密钥管理", allowedUserTypes: [3, 4] } },
      { path: "workspace/api-keys", component: RoleBasedView, props: { view: "api-keys" }, meta: { title: "API 密钥", allowedUserTypes: [3, 4] } },
      { path: "workspace/usage-records", component: RoleBasedView, props: { view: "usage-records" }, meta: { title: "使用记录", allowedUserTypes: [3, 4] } },
      ...
      // ── 租户自助 Platform ──
      { path: "account", component: RoleBasedView, props: { view: "account" }, meta: { title: "积分账户", allowedUserTypes: [3, 4] } },
