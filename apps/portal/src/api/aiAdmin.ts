...
function toRiskConfig(value: RiskControlConfigTransport): RiskControlConfigDTO {
  return {
    ...
    keyword_upstream_account_ids: (value as RiskControlConfigTransport & { keyword_upstream_account_ids?: string[] }).keyword_upstream_account_ids ?? [],
    provider_upstream_account_ids: (value as RiskControlConfigTransport & { provider_upstream_account_ids?: string[] }).provider_upstream_account_ids ?? [],
...
function toRiskControlConfigBody(value: RiskControlConfigWriteRequest): RiskControlConfigWriteBody {
  return {
    ...
    provider: {
		...
		mode: value.provider.mode ?? "openai",
      base_url: value.provider.base_url,
      model: value.provider.model,
    ...
    sample_rate: value.sample_rate,
    scope_group_ids: value.scope_group_ids,
    keyword_upstream_account_ids: value.keyword_upstream_account_ids,
    provider_upstream_account_ids: value.provider_upstream_account_ids,
    verdict_cache_ttl_seconds: value.verdict_cache_ttl_seconds,
    violation_window_hours: value.violation_window_hours,
    risk_event_threshold: value.risk_event_threshold,
    record_non_hits: value.record_non_hits,
