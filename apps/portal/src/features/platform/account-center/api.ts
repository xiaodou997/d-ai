...
export const accountCenterApi: AccountCenterApi = {
  getPoints: (detail = true) => platformTenantApi.getAccountBalance(detail),
  getCash: () => tenantApi.getCashAccount(),
  listPointRecords: (page, size) => platformTenantApi.getRechargeRecords({ page, size, rechargeType: "1" }),
