...
import AdminTenantPolicyPanel from "./policy/components/AdminTenantPolicyPanel.vue";
import { resolvePolicyErrorMessage } from "./policy/errorMessage";
...
async function loadTenant() {
  ...
  try {
    ...
    ElMessage.error(resolvePolicyErrorMessage(error, "加载租户信息失败"));
  } finally {
    loading.value = false;
  }
}
