...
func usageLogFromRow(row dbgen.ListUsageLogsRow) domain.UsageLog {
	return domain.UsageLog{
		...
		APIKeyLastFour:                     row.ApiKeyLastFour.String,
		...
		SettlementError:                    row.SettlementError.String,
		RefundStatus:                       row.RefundStatus,
		RefundReason:                       row.RefundReason.String,
		RefundOperatorID:                   row.RefundOperatorID.String,
		SettledAt:                          akTimePtr(row.SettledAt),
		RefundedAt:                         akTimePtr(row.RefundedAt),
