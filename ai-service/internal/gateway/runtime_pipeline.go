...
import (
	...
	"xiaodou/unihub/ai-service/internal/observability"
...
func (s *Gateway) ServeRuntime(w http.ResponseWriter, r *http.Request, capType domain.CapabilityType, override RuntimeOverride, identity *domain.RuntimeIdentity, forceStream bool) *serving.Request {
