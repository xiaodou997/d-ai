...
func (s *Console) handleAdminListCredentialPools(w http.ResponseWriter, r *http.Request) {
...
func (s *Console) handleAdminCreateCredentialPool(w http.ResponseWriter, r *http.Request) {
...
func (s *Console) handleAdminPatchCredentialPool(w http.ResponseWriter, r *http.Request) {
...
func (s *Console) handleAdminDeleteCredentialPool(w http.ResponseWriter, r *http.Request) {
	poolID := chi.URLParam(r, "poolID")
	if poolID == "" {
		writeErr(w, http.StatusBadRequest, BizErrBadRequest, "poolID is required")
		return
...
func (s *Console) handleAdminListPoolCredentials(w http.ResponseWriter, r *http.Request) {
	poolID := chi.URLParam(r, "poolID")
	if poolID == "" {
		writeErr(w, http.StatusBadRequest, BizErrBadRequest, "poolID is required")
		return
...
func (s *Console) handleAdminCreatePoolCredential(w http.ResponseWriter, r *http.Request) {
	poolID := chi.URLParam(r, "poolID")
	if poolID == "" {
		writeErr(w, http.StatusBadRequest, BizErrBadRequest, "poolID is required")
		return
...
func (s *Console) handleAdminPatchPoolCredential(w http.ResponseWriter, r *http.Request) {
...
func (s *Console) handleAdminDeletePoolCredential(w http.ResponseWriter, r *http.Request) {
	credID := chi.URLParam(r, "credID")
	if credID == "" {
		writeErr(w, http.StatusBadRequest, BizErrBadRequest, "credID is required")
		return
...
func (s *Console) handleAdminRefreshPoolCredential(w http.ResponseWriter, r *http.Request) {
	credID := chi.URLParam(r, "credID")
	if credID == "" {
		writeErr(w, http.StatusBadRequest, BizErrBadRequest, "credID is required")
		return
...
func (s *Console) handleAdminGetPoolAvailableModels(w http.ResponseWriter, r *http.Request) {
	poolID := chi.URLParam(r, "poolID")
	if poolID == "" {
		writeErr(w, http.StatusBadRequest, BizErrBadRequest, "poolID is required")
		return
...
func (s *Console) handleAdminGetOAuthPoolHealth(w http.ResponseWriter, r *http.Request) {
