  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '账户全景', requiresAuth: true }
      },
      // 业务管理
      {
        path: '/tenants',
      ...
      },
      {
        ...
        meta: { title: '租户详情', requiresAuth: true, hidden: true }
      },
      {
        path: '/users',
        name: 'UserList',
      ...
      },
      {
        ...
        meta: { title: '应用系统', requiresAuth: true }
      },
      {
        path: '/ai-gateway',
        name: 'AIGateway',
        component: () => import('@/views/AIGateway/index.vue'),
        meta: { title: 'AI 网关', requiresAuth: true }
      },
      // 财务中心
      {
        ...
        meta: { title: '租户充值', requiresAuth: true }
      },
      {
      ...
      // 系统审计
      {
        ...
        meta: { title: '操作审计', requiresAuth: true, superAdminOnly: true }
      },
      {
        path: '/system/admins',
        name: 'AdminList',
        component: () => import('@/views/System/AdminUserList.vue'),
        meta: { title: '系统管理员', requiresAuth: true, superAdminOnly: true }
      },
      {
        path: '/system/jwt-keys',
        name: 'JwtKeys',
        component: () => import('@/views/System/JwtKeys.vue'),
        meta: { title: 'JWT 密钥', requiresAuth: true, superAdminOnly: true }
      }
    ]
  }
]
